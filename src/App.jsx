...
function App() {
  ...
  function handleSectionChange(e) {
    ...
    const { id } = form;
    const { arrayName } = form.dataset; // This extracts the arrayName from the data-array-name attribute of the form
  ...
  function removeForm(e) {
    const form = e.target.closest(".section-form");
    const { arrayName } = form.dataset; // to tell whehter it's edu or exp section
    const section = sections[arrayName];
    const { id } = form;
  ...
  // Toggles between collapsed form and expanded form
